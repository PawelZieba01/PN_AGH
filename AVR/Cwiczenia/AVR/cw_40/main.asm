...
MainLoop:						
								...
								ldi R16, 10					//liczba do porównania z Digit_0
								inc Digit_0					//zwiêszenie Digit_0
								cp Digit_0, R16				//porównanie
								brne PC+3					//jeœli Digit_0 przekroczy zakres (>9) to
								ldi R16, 0					//za³aduj 0 do R16
								mov Digit_0, R16			//wyzeruj Digit_0
															//w przeciwnym wypadku przeskocz dwie instrukcje
								rjmp MainLoop				
